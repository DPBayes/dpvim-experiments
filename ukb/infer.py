...
from dpsvi import AlignedGradientDPSVI, NaturalGradientDPSVI, AlignedNaturalGradientDPSVI, PreconditionedGradientDPSVI, VanillaDPSVI
...
def main():
    ...
    parser.add_argument("--epsilon", type=float, default=1., help="Privacy level")
    ...
    if len(train_data_whole) == 1:
        ...
        dpsvi_type = AlignedGradientDPSVI
        if args.dpvi_flavour == "ng":
            dpsvi_type = NaturalGradientDPSVI
        elif args.dpvi_flavour == "aligned_ng":
            dpsvi_type = AlignedNaturalGradientDPSVI
        elif args.dpvi_flavour == "precon":
            dpsvi_type = PreconditionedGradientDPSVI
        elif args.dpvi_flavour == "vanilla":
            dpsvi_type = VanillaDPSVI

        print(f"Using the {dpsvi_type} algorithm")
        ...
        output_name = filenamer(args.dpvi_flavour, "", args)
