...
from dpsvi import PreconditionedGradientDPSVI

"""
Inference script for testing the data generating model with the preconditioning alternative to aligned DPVI
"""
...
def main():
    ...
    # train model
    optimizer = Adam(1e-3)
    svi = PreconditionedGradientDPSVI(
        model,
        guide,
        optimizer,
    ...
    output_name = filenamer("precon", args)
